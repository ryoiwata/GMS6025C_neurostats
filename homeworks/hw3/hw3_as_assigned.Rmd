...
**Assuming significance with a p-value less than 0.05, we can not reject the null hypothesis that the mean enzyme activity of different enzyme variants are not significantly different from each other. F(4, 144 ) = 0.69, p = 0.60 We can reject the null hypothesis that the Glumate concentration has a statistically significant effect on the enzyme activity. F(1, 144 ) = 50.79, p = 4.56e-11**
