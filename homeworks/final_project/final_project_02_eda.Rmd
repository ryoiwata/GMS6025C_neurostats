...
```{r}
# all_addiction_data |> ggplot(aes(qol.general_health)) +
#   geom_histogram()
# 
# all_addiction_data |> ggplot(aes(qol.psychological_health)) +
#   geom_histogram()
# 
# all_addiction_data |> ggplot(aes(qol.physical_health)) +
#   geom_histogram()
# 
# all_addiction_data |> ggplot(aes(qol.social_health)) +
#   geom_histogram()
# 
# all_addiction_data |> ggplot(aes(qol.environmental_health)) +
#   geom_histogram()
```
